...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<h2${ssrRenderAttrs(_attrs)}>details</h2>`);
}
...
const details__id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { details__id_ as default };
//# sourceMappingURL=details-_id_-a5ab4167.mjs.map

import { withAsyncContext, reactive, unref, useSSRContext } from 'file:///Users/yinlu/Downloads/starter-3/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { b as useRoute } from '../server.mjs';
import { u as useFetch } from './fetch-3f760c76.mjs';
import { ssrInterpolate, ssrRenderClass } from 'file:///Users/yinlu/Downloads/starter-3/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><header class="header-container"><h6 class="title">${ssrInterpolate(unref(dataObj).title)}</h6><div class="other">`);
      if (unref(dataObj).author) {
        _push(`<p class="author">\u4F5C\u8005\uFF1A${ssrInterpolate(unref(dataObj).author)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<a href="./index.html">\u968F\u5FC3\u745C\u540D\u5E08\u5802</a>`);
      if (!unref(dataObj).hadFollow) {
        _push(`<button type="button"></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></header><div class="article-container"><div class="article-main">${unref(dataObj).content}</div><div class="article-other"><p>\u9605\u8BFB\xA0\xA0${ssrInterpolate(unref(dataObj).readNum)}\u6B21</p><div><i class="${ssrRenderClass({ active: unref(dataObj).hadPraise })}"></i><span class="${ssrRenderClass({ active: unref(dataObj).hadPraise })}">${ssrInterpolate(unref(dataObj).praiseNum)}</span></div></div></div><!--]-->`);
    };
  }
};
...
//# sourceMappingURL=_id_-9e25d19a.mjs.map

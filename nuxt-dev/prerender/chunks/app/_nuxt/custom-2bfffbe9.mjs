import { ssrRenderAttrs, ssrRenderSlot } from 'file:///Users/yinlu/Downloads/starter-3/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><p>custom layouts</p><div>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</div><p>custom layouts</p></div>`);
}
...
//# sourceMappingURL=custom-2bfffbe9.mjs.map

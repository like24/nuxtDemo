...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}>The Header</div>`);
}
...
const TheHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { TheHeader as default };
//# sourceMappingURL=TheHeader-eac659de.mjs.map
